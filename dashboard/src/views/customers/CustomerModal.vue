...
const billingCountry = computed(() => countryStore.items.find(c => c.code === customer.value.billingAddress.country_code));
...
const shippingCountry = computed(() => countryStore.items.find(c => c.code === customer.value.shippingAddress.country_code))
